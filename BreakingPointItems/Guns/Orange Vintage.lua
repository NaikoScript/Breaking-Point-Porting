...
local SkinName = "Orange Vintage" -- Name of the skin
local Rarity = "Uncommon" -- The rarity of the skin [Common, Uncommon, Rare, Legendary, Divine, Exotic]
local SwapTheSkinLocally = true -- Determines if the skin will be swapped on your knife when you hold it or on your table

-- Image data --
local Images = {749927745}
local Data = {749244393}
