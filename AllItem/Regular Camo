...
local SkinName = "Regular Camo" -- Name of the skin
local Rarity = "Common" -- The rarity of the skin [Common, Uncommon, Rare, Legendary, Divine, Exotic]
local SwapTheSkinLocally = true -- Determines if the skin will be swapped on your knife when you hold it or on your table

-- Image data --
local Images = {749917147}
local Data = {748898389}
