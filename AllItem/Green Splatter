...
local SkinName = "Green Splatter" -- Name of the skin
local Rarity = "Rare" -- The rarity of the skin [Common, Uncommon, Rare, Legendary, Divine, Exotic]
local SwapTheSkinLocally = true -- Determines if the skin will be swapped on your knife when you hold it or on your table

-- Image data --
local Images = {749930550}
local Data = {749791613}
